...
ctrlproxy$(EXEEXT): server.o posix.o client.o line.o main.o state.o util.o hooks.o linestack.o plugins.o config.o isupport.o $(shell test -n "$(MODS_STATIC)" && echo mods/static.o)
	$(CC) $(LIBS) -rdynamic -o $@ $^
